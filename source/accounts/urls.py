...
urlpatterns = [
    ...
    path('predictStockPrice/', views.predictStockPrice, name='predictStockPrice'),
    path('predictStockPriceDataset/', views.predictStockPriceDataset, name='predictStockPriceDataset'),



    path('profile/', TemplateView.as_view(template_name='profile.html'), name='profile'),
    path('upload/', TemplateView.as_view(template_name='upload_file.html'), name='upload'),
